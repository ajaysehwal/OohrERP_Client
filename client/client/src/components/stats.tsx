...
export default function Stats() {
  return (
    <div id="solution" style={{width:"90%",margin:"auto"}}>
    <div>
...
In pursuit of this vision, we proudly offer free-of-cost software solutions. Our commitment is unwavering - we're here to empower every school, regardless of their resources, to offer the best in education. Together, let's illuminate the path to knowledge and equip our schools with the tools they need to sculpt a generation of forward-thinkers, innovators, and leaders.
             </p>
