...
import empty from "./images/emptymessagebox.png"
  ...
  return (
    <li className="relative" x-data="{ dropdownOpen: false, notifying: true }">
      ...
      <div
        ...
        className={`absolute -right-16 mt-2.5 flex h-45 w-75 flex-col rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark sm:right-0 sm:w-80 ${
